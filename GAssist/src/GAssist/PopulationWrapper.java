 ...
 */
  ...
  public static void testClassifier(int num, double[] f1,double[] f2,Classifier ind, String typeOfTest,
...
//    PerformanceAgent.dumpStats(typeOfTest);
    f1[num]=100-100*PerformanceAgent.getAccuracy();
    f2[num]=PerformanceAgent.getNumAliveRules();
//    LogManager.println("");
  }
